...
const translations = {
  es: {
    ...
    'contact.validation.nameMinLength': 'El nombre debe tener al menos 2 caracteres',
    'contact.validation.nameMaxLength': 'El nombre no puede exceder 50 caracteres',
    'contact.validation.emailRequired': 'El email es requerido',
    'contact.validation.emailInvalid': 'Por favor, ingresa un email válido',
    'contact.validation.messageRequired': 'El mensaje es requerido',
    'contact.validation.messageMinLength': 'El mensaje debe tener al menos 10 caracteres',
    'contact.validation.messageMaxLength': 'El mensaje no puede exceder 1000 caracteres',
    'contact.validation.securityError': 'El mensaje contiene contenido no permitido',
  ...
  en: {
    ...
    'contact.validation.nameMinLength': 'Name must be at least 2 characters',
    'contact.validation.nameMaxLength': 'Name cannot exceed 50 characters',
    ...
    'contact.validation.messageMinLength': 'Message must be at least 10 characters',
    'contact.validation.messageMaxLength': 'Message cannot exceed 1000 characters',
    'contact.validation.securityError': 'Message contains disallowed content',
